...
Metodologia (pedida explicitamente por el usuario):
...
- Se reutilizan los mismos folds temporales que ya usan los notebooks
  (validar cada anio 2013-2022 entrenando con los 5 anios anteriores).
...
DATASET_DIR = Path(__file__).resolve().parents[0]
# Se pisa mas abajo con la ruta real del proyecto.
