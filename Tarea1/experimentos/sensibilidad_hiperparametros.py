"""
Corre las busquedas de hiperparametros del arbol (con min_samples_leaf,
...
Mismo protocolo de siempre: 19 folds temporales (2005-2023, ventana de
...
def main():
    ...
    # ---- ARBOL (con min_samples_leaf, arquitectura final) ----
    grilla_arbol = {
        **discretizer_grid,
    ...
    df_arbol.to_csv(task_dir / "experimentos" / "resultados" / "cv_results_arbol.csv", index=False)
    ...
    df_bayes.to_csv(task_dir / "experimentos" / "resultados" / "cv_results_bayes.csv", index=False)
