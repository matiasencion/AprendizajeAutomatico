...
- Validacion cruzada temporal: validar cada anio 2005-2023 (19 folds),
...
def main():
    ...
    print(f"Folds temporales: {len(temporal_splits)} (2005-2023, ventana de 5 anios)")
    ...
    out_path = task_dir / "experimentos" / "resultados" / "experimento_sklearn_resultados_actual.json"
